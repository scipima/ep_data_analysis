...
## Read data -------------------------------------------------------------------
### RCV ------------------------------------------------------------------------
meps_rcv_mandate <- data.table::fread( here::here("data_out", "meps_rcv_mandate_10.csv") ) 
...
who_won_house_polgroup |> 
  ggplot(aes(x = factor(rcv_id), y = forcats::fct_rev(political_group), 
             fill = factor(is_same))) +
...
ggsave(here::here("figures", "polgroup_winshares.pdf"), 
       dpi=300, device = "pdf", height=4, width=8) 
ggsave(here::here("figures", "polgroup_winshares.png"), 
       dpi=300, device = "png", height=4, width=8)
```
