...
not vote, despite being present; 2) the times we voted against the file
on final votes.

Linking based on Procedure-Doc ID- Decision ID
```{r}
proc_ids_target = c(
...
relevant_docids_gender<- procedures_docs$doc_id[
  which(procedures_docs$process_id %in% proc_ids_target)]

rcv_ids_relevant_gender<- pl_votes$rcv_id[which(pl_votes$doc_id.x %in%
                                                  relevant_docids_gender)]
...
LInking based on Procedure-Voting Item-Decision ID
```{r}
votes_relevant_gender<- gsub("eli/dl/event/", "" ,votes_inverse_consists_of$event_vot_itm_id[
  which(votes_inverse_consists_of$process_id %in%
          c("eli/dl/proc/2024-2125", "eli/dl/proc/2024-2057","eli/dl/proc/2025-2780",
            "eli/dl/proc/2022-0426", "eli/dl/proc/2022-0400","eli/dl/proc/2022-0066",
            "eli/dl/proc/2021-0050","eli/dl/proc/2012-0299", "eli/dl/proc/2022-0401",
            "eli/dl/proc/2016-0062B", "eli/dl/proc/2016-0062R", "eli/dl/proc/2020-0011",
            "eli/dl/proc/2016-0062A", "eli/dl/proc/2021-2035", "eli/dl/proc/2020-2035",
...
rcv_ids_relevant_gender<- voteids_rcvs$rcv_id[
  which(voteids_rcvs$vot_id %in% votes_relevant_gender)
]
