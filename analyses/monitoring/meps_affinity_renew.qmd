...
#   dplyr::mutate(
#     party_wgt = 1/n_meps,
#     group_dist_avg_norm_wgt = group_dist_avg_norm * party_wgt,
#     dist_diff_wgt = group_dist_avg_norm_wgt - renew_dist_avg_norm) |> 
#   dplyr::select(
#     mep_name, political_group, country_party,
#     group_dist_avg_norm, group_dist_avg_norm_wgt,
#     renew_dist_avg_norm, 
#     n_meps, party_wgt,
#     dist_diff, dist_diff_wgt) |> 
#   dplyr::slice_max(dist_diff_wgt, n = 50)
```
