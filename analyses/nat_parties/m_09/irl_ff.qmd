...
country_iso3c <- "IRL"
country_iso2 <- "IE"
country_int <- country_dict$country_id[country_dict$country_iso3c == country_iso3c]
country_adj <- "Irish"
renew_country_party_id <- c(5258L, 6741L)
...
# Fix GUE/The Left
meps_rcv_mandate[polgroup_id %in% c(5151L, 7036L), polgroup_id := 6259L]
...
who_won_group_party_mean_plot |> 
  ...
  geom_jitter(aes(colour = factor(is_countryparty), 
                  size = factor(is_countryparty) ), 
              width = 0.1) +
...
#   "figures", paste0(country_iso3c, "_meps_party_group_align.jpeg")), 
...
renew_party_mjrt <- who_won_bygroup[
...
# ggsave(filename = here::here("figures", paste0(country_iso3c, "_meps_distance.jpeg")), 
