...
# More robust and expressive alternative --------------------------------------#
# data.table::setnames(x = Products, old = ("id"), new = ("product_id"))
# data.table::setnames(x = ProductReceived, old = ("id"), new = ("received_id"))
# Products[
#     ProductReceived,
#     list(product_id, name, price, unit, type, order_id, date, count,
...
## Joins based on several columns ----------------------------------------------
